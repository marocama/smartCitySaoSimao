      ...
      <div class="relative flex items-center justify-between h-16">
        <div class="flex items-center px-2 lg:px-0">
          <div class="flex-shrink-0">
            <img class="w-auto h-12" :src="require('@/assets/logo.svg')" alt="Logo" />
          </div>
          <div class="hidden lg:block lg:ml-14">
            <div class="flex space-x-4">
              ...
              <a href="/tourism/" class="text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Pontos Turísticos</a>
              <a href="/townHall/" class="text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Prefeitura</a>
              <a href="#" class="text-gray-300 hover:bg-gray-900 hover:text-white px-3 py-2 rounded-md text-sm font-medium"></a>
            </div>
          </div>
        </div>
        ...
        <div class="flex">
        <div class="hidden lg:block lg:ml-4 mr-3">
          <div class="flex items-center">
            <div class="ml-4 relative flex-shrink-0">
              <div>
                <button @click="user = !user" type="button" class="p-2 bg-gray-300 rounded-full flex text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
        ...
        <router-link to="/guide/announce">
        <button type="button" class="p-2 bg-gray-300 rounded-full flex text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
          <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><path fill="currentColor" d="M3 6c0-1.1.9-2 2-2h8l4-4h2v16h-2l-4-4H5a2 2 0 0 1-2-2H1V6h2zm8 9v5H8l-1.67-5H5v-2h8v2h-2z"/></svg>
        </button>
        </router-link>
        </div>
      </div>
