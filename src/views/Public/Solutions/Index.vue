<template>
  <main class="mt-2 md:h-full flex flex-col">
    <ul class="mb-5 grid sm:grid-cols-2 md:grid-cols-4 gap-5 gap-y-7">
      <router-link to="/solutions/transport" class="p-4 bg-white border border-gray-200 rounded-lg shadow-md transform duration-150 cursor-pointer hover:scale-105 hover:shadow-xl select-none" active-class="md:scale-105 ring-2 ring-purple-500">
      ...
      <router-link to="/solutions/ride" class="p-4 bg-white border border-gray-200 rounded-lg shadow-md transform duration-150 cursor-pointer hover:scale-105 hover:shadow-xl select-none" active-class="md:scale-105 ring-2 ring-blue-500">
        <div class="-mt-7 mb-2 flex justify-between items-end">
      ...
      <router-link to="/solutions/rural" class="p-4 bg-white border border-gray-200 rounded-lg shadow-md transform duration-150 cursor-pointer hover:scale-105 hover:shadow-xl select-none" active-class="md:scale-105 ring-2 ring-green-500">
        <div class="-mt-7 mb-2 flex justify-between items-end">
      ...
      <router-link to="/solutions/collect" class="p-4 bg-white border border-gray-200 rounded-lg shadow-md transform duration-150 cursor-pointer hover:scale-105 hover:shadow-xl select-none" active-class="md:scale-105 ring-2 ring-yellow-500">
        <div class="-mt-7 mb-2 flex justify-between items-end">
