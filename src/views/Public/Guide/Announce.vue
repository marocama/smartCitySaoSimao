...
export default {
  data() { return {
    ...
    options: {
      ...
      'Eventos e Serviços': ['Artigos para Festa', 'Artistas', 'Bar Man', 'Brinquedos infláveis', 'Casamentos', 'Chácaras e Sítios', 'Convites', 'Convites e Lembrancias', 'Decoração de Festas', 'DJ', 'Eventos', 'Foto e Vídeo', 'Gelo', 'Lembrancinhas', 'Local para Festas', 'Pães Doces e Salgados - Entreterimento', 'Produção de Eventos', 'Sonorização'], 
